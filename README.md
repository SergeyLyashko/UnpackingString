...
Решение: 
Реализовано приложение, запрашивающее в цикле строки для распаковки до ввода команды "quit",
поддерживает ввод числовых коэффициентов распаковки свыше 1 порядка и 
валидацию строк с указанием причины ошибки.
